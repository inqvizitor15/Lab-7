...
category = input(
    'Выберите одну из категорий, по которой хотите увидеть новость (business, entertainment, general, health, science, sports, technology): ')
...
url = f"{url_main}country={country}&category={category}&pageSize={page_size}&apiKey={API_KEY}"
# print(url)
